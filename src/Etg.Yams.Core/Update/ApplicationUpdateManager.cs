...
namespace Etg.Yams.Update
{
    public class ApplicationUpdateManager : IApplicationUpdateManager
    {
        ...
        public ApplicationUpdateManager(
            ...
            IDeploymentStatusManager deploymentStatusManager)
        {
        ...
        {
            await _deploymentStatusManager.UpdateDeploymentStatusAtomically(currentDeploymentStatus =>
            {
                DateTime utcNow = DateTime.UtcNow;
                var instanceDeploymentStatus = new InstanceDeploymentsStatus();
                ...
                ClusterDeploymentStatus deploymentStatus = currentDeploymentStatus.GetClusterDeploymentStatus(_clusterId);
                if(deploymentStatus == null)
                {
                    deploymentStatus = new ClusterDeploymentStatus();
                }
                deploymentStatus.SetInstanceDeploymentStatus(_instanceId, instanceDeploymentStatus);
                currentDeploymentStatus.SetClusterDeploymentStatus(_clusterId, deploymentStatus);
            });
        }
